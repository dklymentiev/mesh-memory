...
[![CI](https://github.com/dklymentiev/mesh-memory/actions/workflows/ci.yml/badge.svg)](https://github.com/dklymentiev/mesh-memory/actions/workflows/ci.yml)
...
### Demo: Galaxy Map (1000 documents, 15 categories)

![Mesh Demo](app/demo.gif)

*1000 documents visualized as a galaxy. Each particle is a document, clusters form by semantic similarity. Search highlights matching documents in real-time.*
